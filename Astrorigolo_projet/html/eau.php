...
<body>
    ...
    <section>
        <div class="bleumarine">
            <div id="Cancer" class="page">
                <div class="texte">
                    <?php
                ...
                <img src="../img/Cancer.webp" alt="Cancer">
            </div>
            <div class="texte">
                <?php
                ...
                ?>
                <br><br>
                <button class="btn-horoscope" data-signe="4">Voir ma prédiction</button>
                <div class="phrase-container"></div>
            </div>
        </div>
        <div class="blanc">
            <div id="Scorpion" class="page">
                <div class="texte">
                    <?php
                    $id_signes = 8;
                    $stmt->execute([$id_signes]);
            ...
            <div class="texte">
                ...
                ?>
                <br><br>
                <button class="btn-horoscope" data-signe="8">Voir ma prédiction</button>
                <div class="phrase-container"></div>
            </div>
        </div>
        <div class="bleumarine">
            <div id="Poissons" class="page">
                <div class="texte">
                    <?php
                    $id_signes = 12;
                    $stmt->execute([$id_signes]);
                ...
                <img src="../img/Poissons.webp" alt="poisson">
            </div>
            <div class="texte">
                <?php
                echo "<strong>" . $signe['Titre2'] . "</strong>";
                ...
                ?>
                <br><br>
                <button class="btn-horoscope" data-signe="12">Voir ma prédiction</button>
                <div class="phrase-container"></div>
            </div>
        </div>
    </section>
