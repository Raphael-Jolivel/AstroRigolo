    ...
    <section>
        ...
        <div class="gris">
            <div id="Gémeaux" class="page">
                ...
                <img src="../img/Gémeaux.webp" alt="Gémeaux">
            </div>
            <div class="texte">
                <?php
                ...
                ?>
                <br><br>
                <button class="btn-horoscope" data-signe="3">Voir ma prédiction</button>
        ...
        <div class="vert">
            <div id="Balance" class="page">
                ...
                <img src="../img/Balance.webp" alt="Balance">
            </div>
            <div class="texte">
                <?php
                echo "<strong>" . $signe['Titre2'] . "</strong>";
                ...
                ?>
                <br><br>
                <button class="btn-horoscope" data-signe="7">Voir ma prédiction</button>
                <div class="phrase-container"></div>
            </div>
        </div>
        ...
        <div class="gris">
            <div id="Verseau" class="page">
                ...
                <img src="../img/Verseau.webp" alt="Verseau">
            </div>
            <div class="texte">
                <?php
                echo "<strong>" . $signe['Titre2'] . "</strong>";
                ...
                ?>
                <br><br>
                <button class="btn-horoscope" data-signe="11">Voir ma prédiction</button>
                <div class="phrase-container"></div>
            </div>
